...
import com.itmayiedu.feign.CallBackServiceFegin;
...
public class CallBackController {
	...
	public void synCallBack(HttpServletRequest request,HttpServletResponse response) throws IOException {
		...
		log.info("###支付宝同步回调开始CallBackController###synCallBack开始params:{}", params);
		...
		log.info("###支付宝同步回调开始CallBackController###synCallBack结束params:{}", params);
		// 
...
//			valueStr = new String(valueStr.getBytes("ISO-8859-1"), "utf-8");
		...
		log.info("###支付宝异步回调开始CallBackController###asynCallBack结束params:{}", params);
